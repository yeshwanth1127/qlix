...
def load_skill(
    ...
    *,
    ...
    if verify_signature and public_key and manifest.signature:
        try:
            from qlix.luna.security.signing import verify_b64
    ...
    if scan_for_injection:
        try:
            from qlix.luna.security.scanner import SecretScanner
...
def load_skill_directory(path: str | Path) -> SkillManifest:
    ...
    # Promote .source file's source field into manifest.metadata.luna.source
