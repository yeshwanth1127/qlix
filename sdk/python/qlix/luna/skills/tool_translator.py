"""ToolTranslator — translate external tool names to Luna equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Luna uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Luna name
# ---------------------------------------------------------------------------
