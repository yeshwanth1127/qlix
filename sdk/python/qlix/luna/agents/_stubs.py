...
from qlix.luna.core.types import Conversation, Message, Role, ToolResult
...
class ToolUsingAgent(BaseAgent):
    ...
    def __init__(
        ...
        *,
        ...
        from qlix.luna.tools._stubs import ToolExecutor
        ...
        try:
            from qlix.luna.agents.loop_guard import LoopGuard, LoopGuardConfig
