...
Renamed from ``ReActAgent`` to clarify this is Luna's native
...
from qlix.luna.agents.prompt_loader import (
...
from qlix.luna.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from qlix.luna.engine._stubs import InferenceEngine
from qlix.luna.tools._stubs import BaseTool, build_tool_descriptions
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $LUNA_HOME override for the base template (M2+ work).
        prompt_template = (
