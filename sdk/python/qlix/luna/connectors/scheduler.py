...
from qlix.luna.connectors._stubs import BaseConnector
from qlix.luna.connectors.sync_engine import SyncEngine
...
class SyncScheduler:
    ...
    ----------
    sync_engine:
        The :class:`~luna.connectors.sync_engine.SyncEngine` used to
    ...
    def add(self, connector: BaseConnector) -> None:
        ...
        ----------
        connector:
            Any :class:`~luna.connectors._stubs.BaseConnector` instance.
