...
from qlix.luna.agents._stubs import AgentContext, AgentResult, BaseAgent
...
_OUTPUT_START = "---LUNA_OUTPUT_START---"
_OUTPUT_END = "---LUNA_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``luna-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "luna-sandbox:latest"
    DEFAULT_TIMEOUT = 300
