...
from qlix.luna.core.types import Message, TelemetryRecord
from qlix.luna.engine._stubs import InferenceEngine, StreamChunk
from qlix.luna.telemetry.gpu_monitor import GpuSample
...
class InstrumentedEngine(InferenceEngine):
    ...
    :class:`~luna.telemetry.energy_monitor.EnergyMonitor`), it is
