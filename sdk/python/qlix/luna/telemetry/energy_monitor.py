...
def create_energy_monitor(
    ...
    try:
        from qlix.luna.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from qlix.luna.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from qlix.luna.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from qlix.luna.telemetry.energy_rapl import RaplEnergyMonitor
