...
from qlix.luna.engine._base import InferenceEngine
...
def _make_engine(key: str, config: LunaConfig) -> InferenceEngine:
...
def discover_engines(config: LunaConfig) -> List[Tuple[str, InferenceEngine]]:
...
def get_engine(
    config: LunaConfig, engine_key: str | None = None
