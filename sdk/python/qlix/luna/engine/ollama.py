...
from qlix.luna.engine._base import (
    EngineConnectionError,
    InferenceEngine,
    estimate_prompt_tokens,
    messages_to_dicts,
)
from qlix.luna.engine._stubs import StreamChunk
...
class OllamaEngine(InferenceEngine):
    ...
    _DEFAULT_NUM_BATCH = 128

    @staticmethod
    def _env_int(key: str, default: int) -> int:
        try:
            v = int((os.environ.get(key) or "").strip())
    ...
    def __init__(
        ...
        *,
        ...
        # Safe defaults for low-VRAM Windows setups. Override via env vars.
        # These map to Ollama "options" fields.
        self._default_num_ctx = self._env_int("LUNA_OLLAMA_NUM_CTX", self._DEFAULT_NUM_CTX)
        self._default_num_batch = self._env_int("LUNA_OLLAMA_NUM_BATCH", self._DEFAULT_NUM_BATCH)
        ...
        **kwargs: Any,
        ...
        payload: Dict[str, Any] = {
            ...
            "options": {
                ...
                "num_ctx": kwargs.get("num_ctx", self._default_num_ctx),
                "num_batch": kwargs.get("num_batch", self._default_num_batch),
            },
        }
        ...
        if response_format is not None:
            from qlix.luna.engine._stubs import ResponseFormat
