...
Recipes are the universal composition format for Luna.  Each recipe
...
_USER_RECIPES_DIR = Path.home() / ".luna" / "recipes"
_USER_OPERATORS_DIR = Path.home() / ".luna" / "operators"
...
class Recipe:
    ...
    def to_eval_suite(
        ...
        """
        from qlix.luna.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from qlix.luna.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.luna/recipes/`` directory
    4. User ``~/.luna/operators/`` directory
