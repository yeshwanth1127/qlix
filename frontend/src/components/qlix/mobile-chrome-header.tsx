...
export function MobileChromeHeader({ homeHref, workspaceLabel }: MobileChromeHeaderProps) {
  return (
    <header
      className="fixed inset-x-0 top-0 z-50 flex h-12 items-center justify-between border-b border-black/[0.08] bg-white/75 px-4 shadow-[0_8px_24px_-20px_rgba(16,14,22,0.25)] backdrop-blur-2xl md:hidden"
      role="banner"
    >
      <Link
        href={homeHref}
