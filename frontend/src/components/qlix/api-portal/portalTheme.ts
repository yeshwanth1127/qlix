...
export const portalTabActive = {
  ...
  docs: "inline-flex items-center justify-center rounded-full border border-[#012F13] bg-[#012F13] px-3.5 py-1.5 text-[11px] font-medium uppercase tracking-[0.12em] text-[#E2F0CC]",
} as const;

export const portalTabIdle = {
  console: undefined,
  docs: "inline-flex items-center justify-center rounded-full border border-black/15 bg-[#E2F0CC]/60 px-3.5 py-1.5 text-[11px] font-medium uppercase tracking-[0.12em] text-[#012F13] hover:border-black/30",
} as const;
