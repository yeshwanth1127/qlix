...
const TOOL_META: Record<string, { label: string; category: ToolCategory; verb?: string }> = {
  ...
  conversation_start: { label: "Conversation", category: "other", verb: "Start threads" },
  conversation_list: { label: "Conversation", category: "other", verb: "List threads" },
  conversation_get: { label: "Conversation", category: "other", verb: "Read thread" },
  conversation_send: { label: "Conversation", category: "other", verb: "Send on thread" },
  conversation_close: { label: "Conversation", category: "other", verb: "Close thread" },
