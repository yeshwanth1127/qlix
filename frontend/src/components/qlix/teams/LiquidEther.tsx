...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class Simulation {
      options: any; fbos: any; fboSize = new THREE.Vector2(); cellScale = new THREE.Vector2();
      boundarySpace = new THREE.Vector2(); advection: Advection | null = null;
      externalForce: ExternalForce | null = null; viscous: Viscous | null = null;
      divergence: Divergence | null = null; poisson: Poisson | null = null;
