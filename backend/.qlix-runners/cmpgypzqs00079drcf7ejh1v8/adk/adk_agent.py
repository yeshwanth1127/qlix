...
@qlix.agent(
    name="intake proccesor",
    description="Cloud ADK for intake proccesor",
    system_prompt="You are intake proccesor. Follow user intent safely and use tools when useful.",
    model="",
)
