...
@qlix.agent(
    name="leads qualifier",
    description="Cloud ADK for leads qualifier",
    system_prompt="You are leads qualifier. Follow user intent safely and use tools when useful.",
    model="",
)
