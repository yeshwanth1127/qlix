...
@qlix.agent(
    name="India Event Filter",
    description="Cloud ADK for India Event Filter",
    system_prompt="You are India Event Filter. Follow user intent safely and use tools when useful.",
    model="",
)
