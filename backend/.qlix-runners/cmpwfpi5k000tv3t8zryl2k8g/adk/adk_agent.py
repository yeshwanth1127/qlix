...
@qlix.agent(
    name="Loan Compliance Checker",
    description="Cloud ADK for Loan Compliance Checker",
    system_prompt="You are Loan Compliance Checker. Follow user intent safely and use tools when useful.",
    model="",
)
