...
const DEFAULT_TIERS: Array<{
...
}> = [
  {
    ...
    description: 'Spark — economy models, light footprint',
    maxAgents: 3,
  ...
  },
  {
    ...
    includedSuccesses: 0,
    overageRate: new Prisma.Decimal('0'),
    description: 'Ignition — 14-day trial burn',
    maxAgents: 3,
    freeMonthlyCredit: new Prisma.Decimal('0'),
    allowedModelTiers: ['economy'],
    whatsappMsgLimit: 0,
  },
  {
    ...
    includedSuccesses: 0,
    overageRate: new Prisma.Decimal('0'),
    description: 'Nova — solo builders with Auto standard',
    maxAgents: 5,
  ...
  },
  {
    ...
    includedSuccesses: 0,
    overageRate: new Prisma.Decimal('0'),
    description: 'Quasar — teams with advanced pins',
    maxAgents: 15,
  ...
  },
  {
    ...
    includedSuccesses: 0,
    overageRate: new Prisma.Decimal('0'),
    description: 'Helix — org scale and premium models',
    maxAgents: 50,
  ...
  },
  {
    ...
    includedSuccesses: 0,
    overageRate: new Prisma.Decimal('0'),
    description: 'Apex — negotiated enterprise orbit',
    maxAgents: 0,
    freeMonthlyCredit: new Prisma.Decimal('0'),
    allowedModelTiers: ['economy', 'standard', 'advanced', 'premium'],
    whatsappMsgLimit: 0,
