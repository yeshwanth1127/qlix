...
const SCOPE_SKILL_MAP: Record<string, { name: string; description: string }> = {
  ...
  'docs.read': { name: 'Docs Reading', description: 'Read Google Docs documents' },
  'docs.write': { name: 'Docs Writing', description: 'Create or update Google Docs (JIT)' },
  'sheets.read': { name: 'Sheets Reading', description: 'Read Google Sheets spreadsheets and values' },
  'sheets.write': { name: 'Sheets Writing', description: 'Create or update Google Sheets (JIT)' },
  'slides.read': { name: 'Slides Reading', description: 'Read Google Slides presentations' },
  'slides.write': { name: 'Slides Writing', description: 'Create or update Google Slides (JIT)' },
  'forms.read': { name: 'Forms Reading', description: 'Read Google Forms and responses' },
  'forms.write': { name: 'Forms Writing', description: 'Create or update Google Forms (JIT)' },
  ...
  'whatsapp.contact_send': { name: 'WhatsApp', description: 'Message WhatsApp contacts with text, files, or polls (with approval)' },
  'whatsapp.auto_reply': { name: 'WhatsApp', description: 'Compatibility alias for conversation on WhatsApp' },
  conversation: { name: 'Conversations', description: 'Start and manage parallel conversation threads' },
