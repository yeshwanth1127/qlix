...
const SCOPE_SKILL_MAP: Record<string, { name: string; description: string }> = {
  ...
  'drive.read': { name: 'Drive Reading', description: 'List and read files from Google Drive' },
  'drive.write': { name: 'Drive Writing', description: 'Create or update files in Google Drive (JIT)' },
