...
class OllamaEngine(InferenceEngine):
    ...
    def __init__(
        ...
        *,
        ...
        self._default_num_ctx = self._env_int("OPENJARVIS_OLLAMA_NUM_CTX", self._DEFAULT_NUM_CTX)
        self._default_num_batch = self._env_int("OPENJARVIS_OLLAMA_NUM_BATCH", self._DEFAULT_NUM_BATCH)
