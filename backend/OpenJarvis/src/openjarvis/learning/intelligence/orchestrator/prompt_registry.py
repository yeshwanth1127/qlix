...
TOOL_DESCRIPTIONS: Dict[str, dict] = {
    ...
    "open_system_url": {
        "category": "utility",
        "description": (
            "OPEN_SYSTEM_URL - Open a link in the user's real desktop browser\n"
            "  - BEST FOR: 'open X.com', 'launch url', visit site in Chrome\n"
            "  - STRENGTHS: Uses real Google Chrome when installed; not Playwright\n"
            "  - USE WHEN: User explicitly wants a website opened locally\n"
            "  - COST: Free\n"
            "  - Input: url (https://... or hostname)"
        ),
        "examples": [
            {
                "task": "Open ycombinator.com in my browser",
                "thought": "User wants the site opened locally — open_system_url.",
